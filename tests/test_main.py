...
def test_main_invalid_menu_choice(mock_mask_card, mock_get_date, mock_filter_state, mock_get_transactions, mock_input):
    ...
    mock_input.side_effect = ["5", "1", "EXECUTED", "нет", "нет", "нет"]
...
def test_main_invalid_status(mock_mask_card, mock_get_date, mock_filter_state, mock_get_transactions, mock_input):
    ...
    mock_input.side_effect = ["1", "INVALID", "EXECUTED", "нет", "нет", "нет"]
...
@patch("main.get_date")
@patch("main.mask_account_card")
def test_main_sort_descending(
    mock_mask_card, mock_get_date, mock_sort_date, mock_filter_state, mock_get_transactions, mock_input
):
...
@patch("main.get_date")
@patch("main.mask_account_card")
def test_main_filter_rub(
    mock_mask_card, mock_get_date, mock_filter_currency, mock_filter_state, mock_get_transactions, mock_input
):
...
@patch("main.get_date")
@patch("main.mask_account_card")
def test_main_search_description(
    mock_mask_card, mock_get_date, mock_search, mock_filter_state, mock_get_transactions, mock_input
):
    ...
    mock_input.side_effect = ["1", "EXECUTED", "нет", "нет", "да", "продукты"]
