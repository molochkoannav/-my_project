...
Отчет о покрытии тестами 93%
![Отчет о покрытии](images/test_2.jpg)
*На скриншоте представлен отчет инструмента pytest --cov=src --cov-branch --cov-report=term, демонстрирующий 93% покрытие кода.*
