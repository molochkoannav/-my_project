...
11.В модуле utils добалена функция process_bank_search для проверки фильтрации транзакций по ключевому слову.
Функция получает на вход список словарей и ключевое слово, 
возвращает список словарей содержащих в описании ключевые слова.

12.В модуле utils добавлена функция process_bank_operations для проверки фильтрации транзакций по категории.
Функция получает на вход список словарей и список с категориями транзакций, 
возвращает словарь в котором ключи это категории, а значения это список транзакций.
...
- test_main.py (Модуль тестирования модуля main.py)
